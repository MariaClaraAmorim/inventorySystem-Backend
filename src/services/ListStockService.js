...
exports.ListStockService = void 0;
var index_1 = require("../prisma/index");
// Classe responsável por executar a lógica para listar estoque
var ListStockService = /** @class */ (function () {
    function ListStockService() {
    }
    // Método assíncrono que executa a listagem de estoque
    ListStockService.prototype.execute = function () {
        return __awaiter(this, void 0, void 0, function () {
            var stocks;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, index_1.default.stock.findMany()];
                    case 1:
                        stocks = _a.sent();
...
exports.ListStockService = ListStockService;
