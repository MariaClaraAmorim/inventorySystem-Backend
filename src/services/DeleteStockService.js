            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, index_1.default.stock.findFirst({
                                where: {
                                    id: id,
                                },
                            })];
                    case 1:
                        ...
                        return [4 /*yield*/, index_1.default.stock.delete({
                                where: {
                                    id: foundStock.id,
                                },
                            })];
