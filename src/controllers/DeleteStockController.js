...
var DeleteStockService_1 = require("../services/DeleteStockService");
// Classe responsável por lidar com as requisições para excluir um estoque
var DeleteStockController = /** @class */ (function () {
    function DeleteStockController() {
    }
    // Método assíncrono que lida com a requisição de exclusão de estoque
    DeleteStockController.prototype.handle = function (request, reply) {
        return __awaiter(this, void 0, void 0, function () {
            var id, stockService, stock;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = request.query.id;
                        stockService = new DeleteStockService_1.DeleteStockService();
                        return [4 /*yield*/, stockService.execute({ id: id })];
                    case 1:
                        stock = _a.sent();
