...
var ListStockService_1 = require("../services/ListStockService");
// Classe responsável por lidar com as requisições para listar estoque
var ListStockController = /** @class */ (function () {
    function ListStockController() {
    }
    // Método assíncrono que lida com a requisição de listagem de estoque
    ListStockController.prototype.handle = function (request, reply) {
        return __awaiter(this, void 0, void 0, function () {
            var listStockService, stock;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        listStockService = new ListStockService_1.ListStockService();
                        return [4 /*yield*/, listStockService.execute()];
                    case 1:
                        stock = _a.sent();
